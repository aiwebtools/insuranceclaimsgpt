...
const features = [
  ...
  {
    icon: <Image className="h-8 w-8 text-purple-300" />,
  ...
  {
    icon: <DollarSign className="h-8 w-8 text-purple-300" />,
...
const Features = () => {
  return (
    <section id="features" className="section-padding bg-gray-950">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index} 
              className="feature-card animate-fade-in-up bg-gray-900 border border-gray-800 hover:border-purple-900"
